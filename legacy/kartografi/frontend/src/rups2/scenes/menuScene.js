...
export default class MenuScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("battery", asset("../components/battery.png"));
        this.load.image("lamp", asset("../components/lamp.png"));
        this.load.image("resistor", asset("../components/resistor.png"));
        this.load.image("switch-off", asset("../components/switch-off.png"));
        this.load.image("switch-on", asset("../components/switch-on.png"));
        this.load.image("wire", asset("../components/wire.png"));
      }
